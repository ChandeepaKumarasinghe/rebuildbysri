    ...
    return (
      <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          <h1
            className="text-[#ff4f00] text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 uppercase tracking-wider leading-tight drop-shadow-lg"
            style={{ fontFamily: "Helvetica, Arial, sans-serif" }}
          >
            Rebuild Your Body
          </h1>
          <h2
            className="text-[#c9c0bb] text-lg sm:text-xl md:text-2xl lg:text-3xl font-light mb-8 leading-relaxed px-2 drop-shadow-md"
            style={{ fontFamily: "Helvetica, Arial, sans-serif" }}
          >
        ...
        {/* Scroll Indicator */}
        <div
          className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 text-[#c9c0bb] text-center"
          style={{ fontFamily: "Helvetica, Arial, sans-serif" }}
        >
